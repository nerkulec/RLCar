...
def timeit(func, runs={}, times={}):
    ...
    if func=='SHOW':
        ...
        if started:
            print(f'The rest took {total_time-sum_times:>5.1f} seconds which is {(total_time-sum_times)/total_time:>6.2%} total time')
...
def cacheit(func): 
    # TODO: make it Vecsible to use a file to cache
